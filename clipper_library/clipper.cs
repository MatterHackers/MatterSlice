...
namespace ClipperLib
{
    ...
    public struct IntPoint
    {
        ...
        public static bool operator ==(IntPoint p0, IntPoint p1)
        {
        ...
        public override bool Equals(object obj)
        {
            if (obj == null || !(obj is IntPoint))
                return false;
            IntPoint untPoint = (IntPoint)obj;
            return (untPoint.X == X && untPoint.Y == Y);
        }

        // TODO: change this to length squared
        ...
        public override int GetHashCode()
        {
            return (new Int64[] { X, Y }).GetHashCode();
        }

        public bool IsShorterThen(int len)
        {
            if (X > len || X < -len)
            {
                return false;
        ...
        {
            double fx = (double)(X) / 1000.0;
            double fy = (double)(Y) / 1000.0;
            return Math.Sqrt(fx * fx + fy * fy);
        }

        // change this to get SetLength
        public IntPoint SetLength(int len)
        {
            long _len = Length();
            if (_len < 1)
            {
        ...
        // change to get perpendicular
        public static IntPoint GetPerpendicular(IntPoint p0)
        {
            return new IntPoint(-p0.Y, p0.X);
        }

        public static long Dot(IntPoint p0, IntPoint p1)
        {
            return p0.X * p1.X + p0.Y * p1.Y;
        }
    }
