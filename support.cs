...
namespace MatterHackers.MatterSlice
{
	...
	public class SupportPolyGenerator
	{
		...
		private SupportStorage supportStorage = new SupportStorage();
		private double supportedAngleFromHorizon;
		private int supportZDistance_um;
		private int interfaceZDistance_um;
		private bool generateInternalSupport;
		private bool[] done;

		private int extraErrorGap = 20;

		private delegate bool CheckForSupport(IntPoint pointToCheckIfNeedsSupport, int currentZHeight_um);
