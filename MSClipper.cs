...
namespace MSClipperLib
{
  ...
  using cInt = Int32;
    ...
    {
      this.X = x; this.Y = y; this.Z = z; Width = 0;
    }
    
    public IntPoint(double x, double y, double z = 0)
    {
      this.X = (cInt)x; this.Y = (cInt)y; this.Z = (cInt)z; Width = 0;
    }
    ...
    public IntPoint(IntPoint pt)
    {
      this.X = pt.X; this.Y = pt.Y; this.Z = pt.Z; this.Width = pt.Width;
		...
		{
			this.X = X; this.Y = Y; this.pathWidth = 0;
		}
		public IntPoint(double x, double y)
		{
			this.X = (cInt)x; this.Y = (cInt)y; this.pathWidth = 0;
		}

		public IntPoint(IntPoint pt)
		{
			this.X = pt.X; this.Y = pt.Y; this.pathWidth = pt.pathWidth;
		}
#endif
