...
namespace MatterHackers.MatterSlice
{
	...
	public class GCodeExport
	{
		...
		{
			return new MSClipperLib.IntPoint(currentPosition_um.X, currentPosition_um.Y);
		}
		...
		public void SetExtruderOffset(int extruderIndex, MSClipperLib.IntPoint extruderOffset_um, int z_offset_um)
		{
